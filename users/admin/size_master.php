...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">List of size</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active">List of size</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
       ...
       <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            <a style="float: right;color: #ffffff;background-color: #dc3545;" class="page-link" href="?f=size_master_reg">Add New size</a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
...
<script type="text/javascript">
 ...
 // view_user();
    ...
    $('#size_list_table tbody').on( 'click', '#view_id', function () {
       ...
       edit_me(data[0],'edit_size_modal','size','SID');
    } );
