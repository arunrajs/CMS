       ...
       <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            <a style="float: right;color: #ffffff;background-color: #dc3545;" class="page-link" href="?f=Materials_master_reg">Add New Materials</a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
...
<script type="text/javascript">
 ...
 // view_user();
    ...
    var table = $('#Machine_list_table').DataTable( {
        "ajax": "php_controller/list_Material.php"
    } );
