...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">List of Material Category</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
       ...
       <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">List of Material Category</h3>
            <a style="float: right;color: #ffffff;background-color: #dc3545;" class="page-link" href="?f=MatCategories_master_reg">Add New Material Category</a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            ...
            <!--  === -->
               <table id="Machine_list_table" class="table table-striped table-bordered" style="width:100%">
          <thead>
            <tr>
              <th>MatCatID</th>
              <th>Category Name</th>
...
<script type="text/javascript">
 ...
 // view_user();
    ...
    var table = $('#Machine_list_table').DataTable( {
        "ajax": "php_controller/list_Material_Category.php"
    } );
